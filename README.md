...
```javascript
import assert from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float32-base-assert@v0.3.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { isAlmostEqual, isAlmostSameValue, isSameValue, isSameValueZero } from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float32-base-assert@v0.3.0-deno/mod.js';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float32-base-assert@v0.3.0-deno/mod.js';
...
[test-image]: https://github.com/stdlib-js/number-float32-base-assert/actions/workflows/test.yml/badge.svg?branch=v0.3.0
[test-url]: https://github.com/stdlib-js/number-float32-base-assert/actions/workflows/test.yml?query=branch:v0.3.0
...
[@stdlib/number/float32/base/assert/is-almost-equal]: https://github.com/stdlib-js/number-float32-base-assert-is-almost-equal/tree/deno

[@stdlib/number/float32/base/assert/is-almost-same-value]: https://github.com/stdlib-js/number-float32-base-assert-is-almost-same-value/tree/deno

[@stdlib/number/float32/base/assert/is-same-value-zero]: https://github.com/stdlib-js/number-float32-base-assert-is-same-value-zero/tree/deno
