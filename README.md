...
```javascript
import assert from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float32-base-assert@v0.2.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { isSameValueZerof, isSameValuef } from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float32-base-assert@v0.2.0-deno/mod.js';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float32-base-assert@v0.2.0-deno/mod.js';
