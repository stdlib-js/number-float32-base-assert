...
```javascript
assert = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float32-base-assert@v0.3.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/number-float32-base-assert@v0.3.0-umd/browser.js"></script>
```
...
[@stdlib/number/float32/base/assert/is-almost-equal]: https://github.com/stdlib-js/number-float32-base-assert-is-almost-equal/tree/umd

[@stdlib/number/float32/base/assert/is-almost-same-value]: https://github.com/stdlib-js/number-float32-base-assert-is-almost-same-value/tree/umd
