...
```javascript
import { isSameValueZerof, isSameValuef } from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float32-base-assert@v0.1.0-deno/mod.js';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float32-base-assert@v0.1.0-deno/mod.js';
