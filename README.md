...
```javascript
import assert from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float32-base-assert@v0.3.0-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { isAlmostEqual, isAlmostSameValue, isSameValue, isSameValueZero } from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float32-base-assert@v0.3.0-esm/index.mjs';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float32-base-assert@v0.3.0-esm/index.mjs';
...
[@stdlib/number/float32/base/assert/is-almost-equal]: https://github.com/stdlib-js/number-float32-base-assert-is-almost-equal/tree/esm

[@stdlib/number/float32/base/assert/is-almost-same-value]: https://github.com/stdlib-js/number-float32-base-assert-is-almost-same-value/tree/esm
